...
class CommentProcessor:
    ...
    def group_comments_by_context(
        self, comments: List[PRComment], code_analyzer: CodeAnalyzer
    ) -> Dict[CodeNode, List[PRComment]]:
    ...
    def get_code_context(
        self, node: CodeNode, code_analyzer: CodeAnalyzer, file_content: str
    ) -> str:
